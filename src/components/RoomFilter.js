...
export default function RoomFilter({rooms}) {
     ...
     people = people.map((item,index) => { 
         return <option key = {index} item = {item}>{item}</option>
     })
    return (
    ...
    <input type="checkbox" name='breakfast' id ='breakast' checked={breakfast} onChange={handleChange}/>
    <label htmlFor="breakfast"> breakfast</label>
    </div>
    <div className="single-extra">
    <input type="checkbox" name='pets' id ='breakast' checked={pets} onChange={handleChange}/>
